...
export var DropPlacement = function DropPlacement(_ref) {
  var relatedKeys = _ref.relatedKeys,
  ...
  var _useDrop = useDrop(function () {
      return {
        ...
        canDrop: function canDrop(item) {
          ...
          throw new Error("Unexpect DragItem property from: ".concat(from, ". \"from\" should be \"external\" or \"internal\"."));
        },
        drop: function drop(item) {
          return _objectSpread(_objectSpread({}, item), {}, {
            parentKey: parentKey,
            originOrder: order,
            // 保留原始的 order，跨层级拖拽时需要用到
